...
guess_encoding("13111_Ota-ku.csv") # ""内に確認するファイル名を入力
...
site.n <- import("13111_Ota-ku.csv", setclass= "tbl_df", encoding ="UTF-8")
...
site.coord <- import("13111_Ota-ku_coord.csv", setclass= "tbl_df", encoding ="UTF-8")
...
#ファイル名を付けて保存
write.csv(site.subtotal, "13111_Ota-kuSJS.csv", row.names = FALSE, fileEncoding = "CP932") #Shift-JIS書き出しforひなたGIS
